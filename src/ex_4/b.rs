...
pub fn run() {
    ...
    for number in drawn_numbers {
        for board in boards.iter_mut() {
            // here's the main difference with part A:
            // instead of just returning once we found the winning board, mark it
            // and let's keep going, skipping winning boards.
            // that way we can keep simulating the game with "losing" boards.
            if (board.won) {
                continue;
            }
